...
## 2b) Histograms
# Create histograms.
qplot(Global_Sales, bins=50, fill=Platform, data=turtle_sales2)
qplot(EU_Sales, bins=50, fill=Platform, data=turtle_sales2)
qplot(NA_Sales, bins=50, fill=Platform, data=turtle_sales2)
...
# Filter data for global sales > 15 to highlight largest
turtle_sales3 <- filter(turtle_sales2,
                        Global_Sales>15)
# View it
View(turtle_sales3)
# Summarise it
...
# Plot it
qplot(Global_Sales, Product, colour=Platform, data=turtle_sales3)
# Export csv for future use
write.csv(turtle_sales3, 'turtle_sales3_assignment.csv') 
###############################################################################
